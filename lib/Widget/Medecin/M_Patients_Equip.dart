...
class M_Patients_Equip extends StatefulWidget {
  @override
  M_Patients_EquipState createState() => M_Patients_EquipState();
}

class M_Patients_EquipState extends State<M_Patients_Equip> {
  ...
  Future Reload() async {
    ...
    print("DbTools.medecin_patientsList.length ${DbTools.medecin_patientsList.length}");
    setState(() {
...
//      if (i < 5)
 ...
 //         visualDensity: VisualDensity(horizontal: 0, vertical: -4),
  ...
  Widget PatientPicker() {
    print(">>>>>>>>>>>>> alphaAdrListView ");
    print(">>>>>>>>>>>>> alphaAdrListView ${normalList.length}");
            ...
            child: ElevatedButton(
              onPressed: () async {
                setState(() {
                  ...
                  DbTools.medecin_patients = ListPatients[wVal];
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => M_Patient()));
